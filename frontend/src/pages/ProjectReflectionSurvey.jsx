...
const FUTURE_PLAN_OPTIONS = [
  { value: 'teach_again_no_changes', label: 'I plan to teach it again without major changes.' },
  { value: 'revise_and_teach_again', label: 'I plan to revise and teach it again.' },
  { value: 'expand_project',         label: 'I plan to expand the project.' },
  { value: 'collaborate',            label: 'I plan to collaborate with another teacher.' },
...
export default function ProjectReflectionSurvey() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.project_name.trim()) {
      setError('Please tell us which STEM project you implemented.')
      return
    }
    setSubmitting(true)
    try {
      ...
      await api.post('teach-stem/project-reflections/', fd)
      setForm(BLANK_FORM)
      setStudentWorkFiles([])
      setSupportingFiles([])
      setSubmitted(true)
  ...
  return (
    <div className="page">
      <div className="hero" style={{ marginTop: 'var(--nav-h)', background: 'linear-gradient(135deg, var(--teal) 0%, var(--teal-dark) 100%)' }}>
        <h1>Teacher STEM Project Reflection</h1>
        <p>Thank you for completing this STEM project with your students! Your feedback helps improve future STEM experiences.</p>
      </div>
        ...
        {submitted ? (
          ...
          <div className="card">
            <form onSubmit={handleSubmit}>
              ...
              {/* Project */}
              <SectionHeading>Which STEM project did you implement? *</SectionHeading>
              ...
              {/* Success rating */}
              <SectionHeading>Overall, how successful was this project in your classroom? *</SectionHeading>
              <RadioGroup
                name="success_rating"
              ...
              {/* Engagement */}
              <SectionHeading>Which of the following best describes your students' engagement during the project? *</SectionHeading>
              <RadioGroup
                name="engagement"
              ...
              <SectionHeading>What evidence did you observe that students met the learning goals? *</SectionHeading>
              ...
              {/* Improvements */}
              <SectionHeading>If you taught this project again, what would you change or improve? *</SectionHeading>
              <div style={{ marginBottom: '1.5rem' }}>
                <textarea
                  className="form-input"
                  rows={4}
              ...
              <SectionHeading>Please upload examples of student work from this project</SectionHeading>
              <p className="text-muted text-sm" style={{ marginBottom: '0.5rem' }}>
                Student names should be removed whenever possible. Photos, PDFs, docs, slides, or videos are all fine.
              </p>
              <FileUploader
                ...
                buttonLabel="+ Upload student work"
              />

              {/* Supporting materials */}
              <SectionHeading>Please upload any supporting materials you created or modified</SectionHeading>
              <p className="text-muted text-sm" style={{ marginBottom: '0.5rem' }}>
                Examples: lesson plans, rubrics, handouts, presentations, or assessments.
              </p>
              <FileUploader
              ...
              {/* Future plans */}
              <SectionHeading>What are your plans for this STEM project in the future? *</SectionHeading>
                ...
                {FUTURE_PLAN_OPTIONS.map(opt => (
                  <label key={opt.value} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.6rem', padding: '0.5rem 0.1rem', cursor: 'pointer' }}>
                    <input
                      ...
                      style={{ accentColor: 'var(--teal)', width: 17, height: 17, marginTop: '0.15rem', flexShrink: 0 }}
                    />
