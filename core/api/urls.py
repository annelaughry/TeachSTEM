...
urlpatterns = [
    ...
    path('teach-stem/project-topics/<int:pk>/', views.api_project_topic_update, name='api_project_topic_update'),
    ...
    path('teach-stem/project-starters/', views.api_project_starters, name='api_project_starters'),
    path('teach-stem/project-starters/<int:pk>/', views.api_project_starter_update, name='api_project_starter_update'),
    ...
    # Staff
    path('program-staff/profile/', views.api_staff_profile, name='api_staff_profile'),
    path('program-staff/project-reflections/', views.api_staff_project_reflections, name='api_staff_project_reflections'),
    path('program-staff/tasks/', views.api_staff_tasks, name='api_staff_tasks'),
    path('program-staff/tasks/<int:pk>/', views.api_staff_task_detail, name='api_staff_task_detail'),
    path('program-staff/tasks/<int:pk>/complete/', views.api_staff_task_complete, name='api_staff_task_complete'),
    path('program-staff/project-topics/', views.api_staff_project_topics, name='api_staff_project_topics'),
    path('program-staff/project-topics/<int:pk>/', views.api_staff_project_topic_update, name='api_staff_project_topic_update'),
    path('program-staff/project-topics/<int:pk>/submit/', views.api_staff_project_topic_submit, name='api_staff_project_topic_submit'),
    path('admin/staff-project-topics/', views.api_admin_staff_project_topics, name='api_admin_staff_project_topics'),
    path('admin/staff-project-topics/<int:pk>/feedback/', views.api_admin_staff_project_topic_feedback, name='api_admin_staff_project_topic_feedback'),
    path('program-staff/project-starters/', views.api_staff_project_starters, name='api_staff_project_starters'),
    path('program-staff/project-starters/<int:pk>/', views.api_staff_project_starter_update, name='api_staff_project_starter_update'),
    path('program-staff/project-starters/<int:pk>/submit/', views.api_staff_project_starter_submit, name='api_staff_project_starter_submit'),
    path('admin/staff-project-starters/', views.api_admin_staff_project_starters, name='api_admin_staff_project_starters'),
    path('admin/staff-project-starters/<int:pk>/feedback/', views.api_admin_staff_project_starter_feedback, name='api_admin_staff_project_starter_feedback'),
    path('admin/teachers/<int:user_id>/toggle-program-staff/', views.api_admin_toggle_program_staff, name='api_admin_toggle_program_staff'),
    path('admin/teachers/<int:user_id>/staff-profile/', views.api_admin_staff_profile, name='api_admin_staff_profile'),
    ...
    path('admin/teachers/<int:user_id>/teach-stem-profile/', views.api_admin_teach_stem_profile, name='api_admin_teach_stem_profile'),
